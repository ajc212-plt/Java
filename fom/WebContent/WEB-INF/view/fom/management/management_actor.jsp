...
<body>
	...
	<main>
		...
		<h2>배우 목록</h2>
		<a href="#"
			onclick="window.open('/fom/actorInsertmove.do', 'actorinsertmove','width=900px, height=900px'); return false">등록</a>
		<!-- <a href="/fom/membersign.do">회원가입</a> -->
		<a href="#"
			onclick="window.open('/fom/aupdatemove.do', 'actorupdatemove','width=900px, height=900px'); return false">수정</a>
		
		<a href="#"
			onclick="window.open('/fom/actordeletemove.do', 'actorinsertmove','width=900px, height=900px'); return false">삭제</a>
		<!-- <a href="/fom/membersign.do">회원가입</a> -->
		<div>
			<table border="1" width="700px">
				...
				<c:forEach items="${actall}" var="row">
					<tr>
					<td><img src="${row.actor_thumbnail}"></td>
