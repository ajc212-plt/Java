...
<title>배우 조회</title>
<link rel="stylesheet" href="/fom/css/resultactor.css">
...
<main>
	...
	<div id="totalbox">
		...
		<!-- 인물 설명-->
		<c:if test="${!empty actresearch}">
			<h1>${actresearch.name}</h1>
		</c:if>
			<div id="imagebox">
			<c:if test="${!empty actresearch}">
				<img src="${actresearch.actor_thumbnail}">
				<div class="container">
					...
					<script>
						...
						function Toggle(){
							if(btn.classList.contains("far")){
								...
								location.href = "/fom/m_actorInsert.do?member_id=${sessionScope.user.member_id}&actor_code=${actresearch.actor_code}";
							}else{
	...
	%>
		...
		<div id="box3">
			<div id="ChartDIv">
					...
					System.out.println("gender_map:" + gender_map);
